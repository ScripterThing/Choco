...
Game.Launch=function()
{
	...
	'<div class="listing">chocolate Clicker is a javascript game by <a href="http://orteil.dashnet.org" target="_blank">Orteil</a> and <a href="http://dashnet.org" target="_blank">Opti</a>.</div>'+
	//'<div class="listing">We have an <a href="https://discordapp.com/invite/chocolate" target="_blank">official Discord</a>, as well as a <a href="http://forum.dashnet.org" target="_blank">forum</a>; '+
	'<div class="listing">We have an <a href="https://discordapp.com/invite/chocolate" target="_blank">official Discord</a>; '+
		'if you\'re looking for help, you may also want to visit the <a href="http://www.reddit.com/r/chocolateClicker" target="_blank">subreddit</a> '+
		'or the <a href="http://chocolateclicker.wikia.com/wiki/chocolate_Clicker_Wiki" target="_blank">wiki</a>.</div>'+
	...
	'<div class="listing" id="supportSection"><b style="color:#fff;opacity:1;">chocolate Clicker is 100% free, forever.</b> Want to support us so we can keep developing games? Here\'s some ways you can help :<div style="margin:4px 12px;line-height:150%;">'+
	...
	'<br>&bull; disable your adblocker<br>&bull; check out our <a href="http://www.redbubble.com/people/dashnet" target="_blank">rad chocolate shirts, hoodies and stickers</a>!<br>&bull; (if you want!)</div></div>'+
	...
	'<div class="listing warning">Warning : clearing your browser cache or chocolates <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!</div>'+
	...
	'<div class="listing">&bull; added fortune chocolates (a new heavenly upgrade)</div>'+
	'<div class="listing">&bull; more upgrades, achievements etc</div>'+
	'<div class="listing">&bull; updated the Russian bread chocolates icon to better reflect their cyrillic origins</div>'+
	'<div class="listing">&bull; also released the official Android version of chocolate Clicker, playable <a href="https://play.google.com/store/apps/details?id=org.dashnet.chocolateclicker" target="_blank">here</a> (iOS version will come later)</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">01/04/2019 - 2.019 (the "this year" update)</div>'+
	'<div class="listing">&bull; game has been renamed to "chocolate Clicker" to avoid confusion</div>'+
	'<div class="listing">&bull; can now click the big chocolate to generate chocolates for free</div>'+
	...
	'<div class="listing">&bull; went back in time and invented chocolates and computer mice, ensuring chocolate Clicker would one day come to exist</div>'+
	...
	'<div class="listing">&bull; released a low-res retro version of the game, playable here : <a href="http://orteil.dashnet.org/experiments/chocolate/" target="_blank">orteil.dashnet.org/experiments/chocolate</a></div>'+
	'<div class="listing">&bull; updated version number</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">05/03/2019 - chocolates for days</div>'+
	'<div class="listing">&bull; added over 20 new chocolates, all previously suggested by our supporters on <a href="https://www.patreon.com/dashnet" target="_blank">Patreon</a></div>'+
	'<div class="listing">&bull; added 2 heavenly upgrades</div>'+
	'<div class="listing">&bull; the Golden goose egg now counts as a golden chocolate upgrade for Residual luck purposes</div>'+
	'<div class="listing">&bull; golden sugar lumps now either double your chocolates, or give you 24 hours of your CpS, whichever is lowest (previously was doubling chocolates with no cap)</div>'+
	...
	'<div class="listing">&bull; added a system to counteract the game freezing up (and not baking chocolates) after being inactive for a long while on slower computers; instead, this will now trigger sleep mode, during which you still produce chocolates as if the game was closed; to enable this feature, use the "Sleep mode timeout" option in the settings</div>'+
	...
	'<div class="listing">&bull; fixed a bug with golden chocolates/reindeer not disappearing properly in some circumstances</div>'+
	...
	'<div class="listing">&bull; "make X chocolates just from Y" requirements are now higher</div>'+
	'<div class="listing">&bull; tweaked the prices of some heavenly upgrades to better fit the current chocolate economy (it turns out billions of heavenly chips is now very achievable)</div>'+
	...
	'<div class="listing">&bull; chocolate Clicker somehow turns 5, going against doctors\' most optimistic estimates</div>'+
	...
	'<div class="listing">&bull; added a couple new chocolates and achievements</div>'+
	...
	'<div class="listing">&bull; new chocolates, milk flavors and achievements</div>'+
	'<div class="listing">&bull; sugar lumps are now unlocked whenever you\'ve baked at least a billion chocolates, instead of on your first ascension</div>'+
	...
	'<div class="listing">&bull; golden chocolates now last 5% shorter for every other golden chocolate on the screen</div>'+
	...
	'<div class="listing">&bull; added link to <a href="https://discordapp.com/invite/chocolate" target="_blank">official Discord server</a></div>'+
	'<div class="listing">&bull; felt weird about pushing an update without content so :</div>'+
	'<div class="listing">&bull; added a handful of new chocolates</div>'+
	...
	'<div class="listing">&bull; chocolate chains no longer spawn from the Force the Hand of Fate spell</div>'+
	'<div class="listing">&bull; bigger, better chocolate Clicker content coming later this year</div>'+
	
	'</div><div class="subsection update">'+
	'<div class="title">08/08/2017 - 4 more years</div>'+
	'<div class="listing">&bull; new building : Chancemakers</div>'+
	'<div class="listing">&bull; new milk, new kittens, new dragon aura, new chocolate, new upgrade tier</div>'+
	...
	'<div class="listing">&bull; chocolate Clicker just turned 4. Thank you for sticking with us this long!</div>'+
	...
	'</div><div class="subsection update small">'+
	'<div class="title">24/07/2016 - golden chocolates overhaul</div>'+
	'<div class="listing">&bull; golden chocolates and reindeer now follow a new system involving explicitly defined buffs</div>'+
	'<div class="listing">&bull; a bunch of new golden chocolate effects have been added</div>'+
	...
	'<div class="listing">&bull; added a new chocolate upgrade near the root of the heavenly upgrade tree; this is intended to boost early ascensions and speed up the game as a whole</div>'+
	'<div class="listing">&bull; due to EU legislation, implemented a warning message regarding browser chocolates; do understand that the irony is not lost on us</div>'+
	...
	'<div class="listing">&bull; mysterious new features such as angel-powered offline progression, challenge runs, and a chocolate dragon</div>'+
	...
	'<div class="listing">&bull; fresh new options to further customize your chocolate-clicking experience</div>'+
	...
	'<div class="listing">Miss the old version? Your old save was automatically exported <a href="http://orteil.dashnet.org/chocolateclicker/v10466/" target="_blank">here</a>!</div>'+
	...
	'<div class="listing">&bull; Additions'+
		...
		'-new option for a less grating chocolate sound (enabled by default)<br>'+
	...
	'<div class="listing">&bull; Changes'+
		...
		'-chocolate upgrades now stack multiplicatively rather than additively<br>'+
		'-golden switch now gives +50% CpS, and residual luck is +10% CpS per golden chocolate upgrade (up from +25% and +1%, respectively)<br>'+
		'-lucky chocolates and chocolate chain payouts have been modified a bit, possibly for the better, who knows!<br>'+
		...
		'-the emblematic chocolate Clicker font (Kavoon) was bugged in Firefox, and has been replaced with a new font (Merriweather)<br>'+
	...
	'<div class="listing">&bull; Fixes'+
		...
		'-the golden chocolate sound should be somewhat clearer<br>'+
	...
	'<div class="listing">&bull; we took so long to make this update, chocolate Clicker turned 2 years old in the meantime! Hurray!</div>'+
	...
	'<div class="listing">&bull; reworked heavenly chips and heavenly chocolates (still experimenting, will probably rebalance things further)</div>'+
	...
	'<div class="listing">&bull; CpS calculations revamped; chocolate upgrades now stack multiplicatively</div>'+
	...
	'<div class="listing">&bull; chocolate Clicker is now 1 year old! (Thank you guys for all the support!)</div>'+
	...
	'<div class="listing">&bull; the dungeons beta is now available on <a href="http://orteil.dashnet.org/chocolateclicker/betadungeons" target="_blank">/betadungeons</a></div>'+
	...
	'<div class="listing">&bull; implemented a simplified version of the <a href="https://github.com/Icehawk78/Frozenchocolates" target="_blank">Frozen chocolates</a> add-on\'s short number formatting</div>'+
	...
	'<div class="listing">&bull; you can now <a href="http://orteil.dashnet.org/chocolates2cash/" target="_blank">convert your chocolates to cash</a>!</div>'+
	...
	'<div class="listing">&bull; you now properly win 1 chocolate upon reaching 10 billion chocolates and making it on the local news</div>'+
	...
	'<div class="listing">&bull; it\'s about time : chocolate Clicker has turned into the much more realistic chocolate Baker</div>'+
	...
	'<div class="listing">&bull; new ultra-expensive batch of seasonal chocolate upgrades you\'ll love to hate</div>'+
	'<div class="listing">&bull; new timer bars for golden chocolate buffs</div>'+
	'<div class="listing">&bull; buildings are now hidden when you start out and appear as they become available</div>'+
	'<div class="listing">&bull; technical stuff : the game is now saved through localstorage instead of browser chocolates, therefore ruining a perfectly good pun</div>'+
	...
	'<div class="listing">&bull; reindeer chocolate drops are now more common</div>'+
	...
	'<div class="listing">&bull; all the Halloween features are still there (and having the Spooky chocolates achievements makes the Halloween chocolates drop much more often)</div>'+
	'<div class="listing">&bull; oh yeah, we now have <a href="http://www.redbubble.com/people/dashnet" target="_blank">chocolate Clicker shirts, stickers and hoodies</a>! (they\'re really rad)</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">29/10/2013 - spooky update</div>'+
	'<div class="listing">&bull; the Grandmapocalypse now spawns wrinklers, hideous elderly creatures that damage your CpS when they reach your big chocolate. Thankfully, you can click on them to make them explode (you\'ll even gain back the chocolates they\'ve swallowed - with interest!).</div>'+
	'<div class="listing">&bull; wrath chocolate now 27% spookier</div>'+
	'<div class="listing">&bull; some other stuff</div>'+
	'<div class="listing">&bull; you should totally go check out <a href="http://candybox2.net/" target="_blank">Candy Box 2</a>, the sequel to the game that inspired chocolate Clicker</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">15/10/2013 - it\'s a secret</div>'+
	'<div class="listing">&bull; added a new heavenly upgrade that gives you 5% of your heavenly chips power for 11 chocolates (if you purchased the Heavenly key, you might need to buy it again, sorry)</div>'+
	'<div class="listing">&bull; golden chocolate chains should now work properly</div>'+
	...
	'<div class="listing">&bull; warning : the chocolate Monster add-on seems to be buggy with this update, you might want to wait until its programmer updates it</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">15/10/2013 - a couple fixes</div>'+
	'<div class="listing">&bull; golden chocolates should no longer spawn embarrassingly often</div>'+
	...
	'<div class="listing">&bull; golden chocolate chains work a bit differently</div>'+
	'<div class="listing">&bull; golden chocolate spawns are more random</div>'+
	'<div class="listing">&bull; CpS achievements are no longer affected by golden chocolate frenzies</div>'+
	'<div class="listing">&bull; revised chocolate-baking achievement requirements</div>'+
	'<div class="listing">&bull; heavenly chips now require upgrades to function at full capacity</div>'+
	'<div class="listing">&bull; added 4 more chocolate upgrades, unlocked after reaching certain amounts of Heavenly Chips</div>'+
	...
	'<div class="listing">&bull; chocolate chains have different capping mechanics</div>'+
	...
	'<div class="listing">&bull; dungeons still need a bit more work and will be released soon - we want them to be just right! (you can test an unfinished version in <a href="http://orteil.dashnet.org/chocolateclicker/betadungeons/" target="_blank">the beta</a>)</div>'+
	
	'</div><div class="subsection update">'+
	'<div class="title">28/09/2013 - dungeon beta</div>'+
	'<div class="listing">&bull; from now on, big updates will come through a beta stage first (you can <a href="http://orteil.dashnet.org/chocolateclicker/betadungeons/" target="_blank">try it here</a>)</div>'+
	'<div class="listing">&bull; first dungeons! (you need 50 factories to unlock them!)</div>'+
	'<div class="listing">&bull; chocolate chains can be longer</div>'+
	'<div class="listing">&bull; antimatter condensers are a bit more expensive</div>'+
	'<div class="listing">&bull; heavenly chips now only give +1% cps each (to account for all the chocolates made from condensers)</div>'+
	'<div class="listing">&bull; added flavor text on all upgrades</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">15/09/2013 - antichocolates</div>'+
	'<div class="listing">&bull; ran out of regular matter to make your chocolates? Try our new antimatter condensers!</div>'+
	'<div class="listing">&bull; renamed Hard-reset to "Wipe save" to avoid confusion</div>'+
	'<div class="listing">&bull; reset achievements are now regular achievements and require chocolates baked all time, not chocolates in bank</div>'+
	...
	'<div class="listing">&bull; golden chocolate clicks are no longer reset by soft-resets</div>'+
	'<div class="listing">&bull; you can now see how long you\'ve been playing in the stats</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">08/09/2013 - everlasting chocolates</div>'+
	'<div class="listing">&bull; added a prestige system - resetting gives you permanent CpS boosts (the more chocolates made before resetting, the bigger the boost!)</div>'+
	'<div class="listing">&bull; save format has been slightly modified to take less space</div>'+
	'<div class="listing">&bull; Leprechaun has been bumped to 777 golden chocolates clicked and is now shadow; Fortune is the new 77 golden chocolates achievement</div>'+
	'<div class="listing">&bull; clicking frenzy is now x777</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">04/09/2013 - smarter chocolate</div>'+
	'<div class="listing">&bull; golden chocolates only have 20% chance of giving the same outcome twice in a row now</div>'+
	'<div class="listing">&bull; added a golden chocolate upgrade</div>'+
	...
	'<div class="listing">&bull; raspberry juice is now named raspberry milk, despite raspberry juice being delicious and going unquestionably well with chocolates</div>'+
	'<div class="listing">&bull; HOTFIX : cursors now click; fancy graphics button renamed; chocolates amount now more visible against cursors</div>'+
	...
	'<div class="listing">&bull; "golden" chocolate now appears again during grandmapocalypse; Elder Pledge-related achievements are now unlockable</div>'+
	...
	'<div class="listing">&bull; reworked the "Bake X chocolates" achievements so they take longer to achieve</div>'+
	...
	'<div class="listing">&bull; added some more upgrades (including a couple golden chocolate-related ones)</div>'+
	...
	'<div class="listing">&bull; added some more chocolate upgrades</div>'+
	'<div class="listing">&bull; added CpS for cursors</div>'+
	'<div class="listing">&bull; added sell button</div>'+
	'<div class="listing">&bull; made golden chocolate more useful</div>'+
	...
	Game.Init=function()
	{
		...
		Game.WriteSave=function(type)
		{
			...
			if (type==3) str+='\n\nMisc game data';
			str+=
			(type==3?'\n	chocolates : ':'')+parseFloat(Game.cookies).toString()+';'+
			(type==3?'\n	total chocolates earned : ':'')+parseFloat(Game.cookiesEarned).toString()+';'+
			(type==3?'\n	chocolate clicks : ':'')+parseInt(Math.floor(Game.cookieClicks))+';'+
			(type==3?'\n	golden chocolate clicks : ':'')+parseInt(Math.floor(Game.goldenClicks))+';'+
			(type==3?'\n	chocolate made by clicking : ':'')+parseFloat(Game.handmadeCookies).toString()+';'+
			(type==3?'\n	golden chocolate missed : ':'')+parseInt(Math.floor(Game.missedGoldenClicks))+';'+
			(type==3?'\n	background type : ':'')+parseInt(Math.floor(Game.bgType))+';'+
			(type==3?'\n	milk type : ':'')+parseInt(Math.floor(Game.milkType))+';'+
			(type==3?'\n	chocolates from past runs : ':'')+parseFloat(Game.cookiesReset).toString()+';'+
			...
			(type==3?'\n	golden chocolate clicks (this run) : ':'')+parseInt(Math.floor(Game.goldenClicksLocal))+';'+
			(type==3?'\n	chocolate sucked by wrinklers : ':'')+parseFloat(Game.cookiesSucked).toString()+';'+
			...
			str+=
			(type==3?'\n	amount of chocolates contained in wrinklers : ':'')+parseFloat(Math.floor(wrinklers.amount))+';'+
			...
			(type==3?'\n	heavenly chocolates : ':'')+parseFloat(Game.heavenlyCookies).toString()+';'+
			...
			(type==3?'\n	amount of chocolates contained in shiny wrinklers : ':'')+parseFloat(Math.floor(wrinklers.amountShinies))+';'+
			...
			(type==3?'\n	golden chocolates fortune : ':'')+parseInt(Game.fortuneGC)+';'+
			(type==3?'\n	CpS fortune : ':'')+parseInt(Game.fortuneCPS)+';'+
			'|';//cookies and lots of other stuff
			
			if (type==3) str+='\n\nBuildings : amount, bought, chocolates produced, level, minigame data';
				...
				if (str!='')
				{
					...
					if (version>=1)
					{
						...
						if (Game.mobile || Game.Has('Perfect idling') || Game.Has('Twin Gates of Transcendence'))
						{
							...
							if (amount>0)
							{
								if (Game.prefs.popups) Game.Popup('Earned '+Beautify(amount)+' chocolate'+(Math.floor(amount)==1?'':'s')+' while you were away');
								else Game.Notify('Welcome back!','You earned <b>'+Beautify(amount)+'</b> chocolate'+(Math.floor(amount)==1?'':'s')+' while you were away.<br>('+Game.sayTime(timeOfflineOptimal*Game.fps,-1)+' at '+Math.floor(percent)+'% CpS'+(timeOfflineReduced?', plus '+Game.sayTime(timeOfflineReduced*Game.fps,-1)+' at '+(Math.floor(percent*10)/100)+'%':'')+'.)',[Math.floor(Math.random()*16),11]);
								Game.Earn(amount);
							}
						}
		...
		Game.Reset=function(hard)
		{
			...
			if (!hard)
			{
				...
				if (Math.round(Game.cookies)==1000000000000) Game.Win('When the chocolates ascend just right');
			}
			...
			if (hard)
			{
				...
				else Game.Notify('Game reset','So long, chocolates.',[21,6],6);
			}
		}
		...
		Game.EarnHeavenlyChips=function(cookiesForfeited)
		{
			...
			if (prestige>Game.prestige)//did we gain prestige levels?
			{
				...
				else Game.Notify('You forfeit your '+Beautify(cookiesForfeited)+' choclates.','You gain <b>'+Beautify(prestigeDifference)+'</b> prestige level'+(prestigeDifference==1?'':'s')+'!',[19,7]);
			}
		}
		...
		Game.GetHeavenlyMultiplier=function()
		{
			...
			if (Game.Has('Heavenly chocolate stand')) heavenlyMult+=0.20;
		...
		Game.Reincarnate=function(bypass)
		{
			...
			else
			{
				...
				if (Game.HasAchiev('Rebirth'))
				{
					...
					else Game.Notify('Reincarnated','Hello, chocolates!',[10,0],4);
				}
		...
		{
			if (!bypass) Game.Prompt('<h3>Ascend</h3><div class="block">Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your chocolates will be converted into prestige and heavenly chips.<div class="line"></div>You will keep your achievements'+(Game.canLumps()?', building levels and sugar lumps':'')+'.</div>',[['Yes!','Game.ClosePrompt();Game.Ascend(1);'],'No']);
			else
			{
				if (Game.prefs.popups) Game.Popup('Ascending');
				else Game.Notify('Ascending','So long, chocolates.',[20,7],4);
		...
		Game.lumpTooltip=function()
		{
			...
			if (phase>=3)
			{
				...
				else if (Game.lumpCurrentType==2) str+='This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current chocolates will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden chocolates for the next 24 hours.';
		...
		Game.harvestLumps=function(amount,silent)
		{
			...
			else if (Game.lumpCurrentType==2)
			{
				...
				else Game.Notify('Sugar blessing activated!','Your chocolates have been doubled.<br>+10% golden chocolates for the next 24 hours.',[29,16]);
			}
		...
		Game.mouseCps=function()
		{
			...
			if (Game.Has('Chocolate egg')) mult*=1.1;
		...
		Game.updateShimmers=function()//run shimmer functions, kill overtimed shimmers and spawn new ones
		{
			...
			//cookie storm!
			if (Game.hasBuff('Chocolate storm') && Math.random()<0.5)
			{
				...
				newShimmer.force='chocolate storm drop';
		...
		Game.shimmerTypes={
			...
			'golden':{
				...
				popFunc:function(me)
				{
					...
					if (me.spawnLead)
					{
						...
						if (Game.goldenClicks>=1) Game.Win('Golden chocolate');
						if (Game.goldenClicks>=7) Game.Win('Lucky chocolate');
					...
					//select an effect
					var list=[];
					if (me.wrath>0) list.push('clot','multiply chocolates','ruin chocolates');
					else list.push('frenzy','multiply chocolates');
					if (me.wrath>0 && Game.hasGod && Game.hasGod('scorn')) list.push('clot','ruin chocolates','clot','ruin chocolates');
					if (me.wrath>0 && Math.random()<0.3) list.push('blood frenzy','chain chocolate','chocolate storm');
					else if (Math.random()<0.03 && Game.cookiesEarned>=100000) list.push('chain chocolate','chocolate storm');
					...
					if (this.chain>0) choice='chain chocolate';
					if (me.force!='') {this.chain=0;choice=me.force;me.force='';}
					if (choice!='chain chocolate') this.chain=0;
					...
					else if (choice=='multiply chocolates')
					{
						...
						Game.Earn(moni);
						popup='Lucky!<div style="font-size:65%;">+'+Beautify(moni)+' chocolates!</div>';
					}
					else if (choice=='ruin chocolates')
					{
						...
						Game.Spend(moni);
						popup='Ruin!<div style="font-size:65%;">Lost '+Beautify(moni)+' chocolates!</div>';
					}
					...
					else if (choice=='chain chocolate')
					{
						//fix by Icehawk78
						...
						{
							this.chain=0;
							popup='Chocolate chain<div style="font-size:65%;">+'+moniStr+' chocolates!<br>Chocolates chain over. You made '+Beautify(this.totalFromChain)+' chocolates.</div>';
						}
						else
						{
							popup='Chocolate chain<div style="font-size:65%;">+'+moniStr+' chocolates!</div>';//
						}
						Game.Earn(moni);
					}
					else if (choice=='chocolate storm')
					{
						buff=Game.gainBuff('chocolate storm',Math.ceil(7*effectDurMod),7);
					}
					else if (choice=='chocolate storm drop')
					{
						...
						Game.Earn(moni);
						popup='<div style="font-size:75%;">+'+Beautify(moni)+' chocolates!</div>';
					}
					else if (choice=='blab')//sorry (it's really rare)
					{
						var str=choose([
						'Chocolates crumbliness x3 for 60 seconds!',
						'Chocolatiness x7 for 77 seconds!',
						'Dough elasticity halved for 66 seconds!',
						'Golden chocolates shininess doubled for 3 seconds!',
						'World economy halved for 30 seconds!',
						'Grandma kisses 23% stingier for 45 seconds!',
						'Thanks for clicking!',
						'Fooled you! This one was just a test.',
						'Golden chocolates clicked +1!',
						'Your click has been registered. Thank you for your cooperation.',
						'Thanks! That hit the spot!',
						'Thank you. A team has been dispatched.',
						'They know.',
						'Oops. This was just a chocolate chocolates with shiny aluminium foil.'
						]);
						popup=str;
					}
					...
					if (choice=='chocolate storm drop')
					{
				...
				missFunc:function(me)
				{
					if (this.chain>0 && this.totalFromChain>0)
					{
						Game.Popup('Chocolate chain broken.<div style="font-size:65%;">You made '+Beautify(this.totalFromChain)+' Chocolates.</div>',me.x+me.l.offsetWidth/2,me.y);
			...
			'reindeer':{
				...
				popFunc:function(me)
				{
					...
					if (Game.prefs.popups) Game.Popup('You found '+choose(['Dasher','Dancer','Prancer','Vixen','Comet','Cupid','Donner','Blitzen','Rudolph'])+'!<br>The reindeer gives you '+Beautify(moni)+' chocolates.'+(cookie==''?'':'<br>You are also rewarded with '+cookie+'!'));
					else Game.Notify('You found '+choose(['Dasher','Dancer','Prancer','Vixen','Comet','Cupid','Donner','Blitzen','Rudolph'])+'!','The reindeer gives you '+Beautify(moni)+' chocolates.'+(cookie==''?'':'<br>You are also rewarded with '+cookie+'!'),[12,9],6);
					popup='<div style="font-size:80%;">+'+Beautify(moni)+' chocolates!</div>';
		...
		Game.goldenCookieChoices=[
			"Frenzy","frenzy",
			"Lucky","multiply chocolates",
			"Ruin","ruin chocolate",
			"Elder frenzy","blood frenzy",
			"Clot","clot",
			"Click frenzy","click frenzy",
			"Cursed finger","cursed finger",
			"chocolate chain","chain chocolate",
			"chocolate storm","chocolate storm",
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu=='prefs')
			{
				...
				Game.WriteButton('particles','particlesButton','Particles ON','Particles OFF')+'<label>(chocolates falling down, etc; disabling may improve performance)</label><br>'+
				...
				Game.WriteButton('monospace','monospaceButton','Alt font ON','Alt font OFF')+'<label>(your chocolates are displayed using a monospace font)</label><br>'+
			...
			else if (Game.onMenu=='stats')
			{
				...
				'<div class="subsection">'+
				'<div class="title">General</div>'+
				'<div class="listing"><b>Chocolates in bank :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookies)+'</div></div>'+
				'<div class="listing"><b>Chocolates baked (this ascension) :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned)+'</div></div>'+
				'<div class="listing"><b>Chocolates baked (all time) :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned+Game.cookiesReset)+'</div></div>'+
				(Game.cookiesReset>0?'<div class="listing"><b>Chocolates forfeited by ascending :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesReset)+'</div></div>':'')+
				...
				'<div class="listing"><b>Chocolates per second :</b> '+Beautify(Game.cookiesPs,1)+' <small>'+
					...
					'</small></div>'+
				'<div class="listing"><b>Chocolates per click :</b> '+Beautify(Game.computedMouseCps,1)+'</div>'+
				'<div class="listing"><b>Chocolate clicks :</b> '+Beautify(Game.cookieClicks)+'</div>'+
				'<div class="listing"><b>Hand-made Chocolates :</b> '+Beautify(Game.handmadeCookies)+'</div>'+
				'<div class="listing"><b>Golden Chocolate clicks :</b> '+Beautify(Game.goldenClicksLocal)+' <small>(all time : '+Beautify(Game.goldenClicks)+')</small></div>'+//' <span class="hidden">(<b>Missed golden cookies :</b> '+Beautify(Game.missedGoldenClicks)+')</span></div>'+
				...
				'</div>':'')+
				(Game.season=='fools'?
					'<div class="listing"><b>Money made from selling Chocolates :</b> $'+Beautify(Game.cookiesEarned*0.08,2)+'</div>'+
				...
				(cookieUpgrades!=''?('<div class="listing"><b>Chocolates</b></div>'+
		...
		Game.getNewTicker=function(manual)//note : "manual" is true if the ticker was clicked, but may also be true on startup etc
		{
			...
			if (Game.TickerN%2==0 || Game.cookiesEarned>=10100000000)
			{
				...
				if (Math.random()<0.75 || Game.cookiesEarned<10000)
				{
					...
					'<q>Moist chocolates.</q><sig>grandma</sig>',
					...
					'<q>I can smell your rotten chocolates.</q><sig>grandma</sig>'
					]));
					...
					'News : free-range farm chocolates popular with today\'s hip youth, says specialist.',
					'News : farm chocolates deemed unfit for vegans, says nutritionist.'
					]));
					...
					'News : cookie factories on strike - workers demand to stop being paid in chocolates!',
					'News : factory-made chocolates linked to obesity, says study.'
					]));
					...
					'News : chocolates slowly creeping up their way as a competitor to traditional currency!',
					...
					'News : "Tomorrow\'s wealthiest people will be calculated by their worth in chocolates", predict specialists.'
					]));
					...
					'News : national gold reserves dwindle as more and more of the precious mineral is turned to chocolates!',
					...
					'News : defective alchemy lab shut down, found to convert chocolates to useless gold.',
					'News : alchemy-made chocolates shunned by purists!'
					]));
					...
					'News : chocolates brought back from the past "unfit for human consumption", says historian.',
					...
					'News : "explain to me again why we need particle accelerators to bake chocolates?" asks misguided local woman.',
					...
					'News : "unravelling the fabric of reality just makes these chocolates so much tastier", claims scientist.'
					]));
					...
					'News : chocolates now being baked at the literal speed of light thanks to new prismatic contraptions.',
					...
					'News : polls find idea of chocolates made of chocolates "acceptable" - "at least we finally know what\'s in them", says interviewed citizen.',
					]));
					...
					'News : children around the world "lost and confused" as any and all Halloween treats have been replaced by chocolates.'
					]));
					...
					'News : boyfriend dumped after offering his lover chocolates for Valentine\'s Day, reports say. "They were off-brand", shrugs ex-girlfriend.'
					]));
				...
				if (Math.random()<0.05)
				{
					...
					if (Game.HasAchiev('A world filled with chocolates')) list.push('News : known universe now jammed with chocolates! No vacancies!');
					...
					if (Game.Has('Kitten marketeers')) list.push('News : nonsensical billboards crop up all over countryside, trying to sell people the chocolates they already get for free!');
				...
				'News : '+choose([
					'chocolates found to '+choose(['increase lifespan','sensibly increase intelligence','reverse aging','decrease hair loss','prevent arthritis','cure blindness'])+' in '+choose(animals)+'!',
					'chocolates found to make '+choose(animals)+' '+choose(['more docile','more handsome','nicer','less hungry','more pragmatic','tastier'])+'!',
					'chocolates tested on '+choose(animals)+', found to have no ill effects.',
					'chocolates unexpectedly popular among '+choose(animals)+'!',
					'unsightly lumps found on '+choose(animals)+' near cookie facility; "they\'ve pretty much always looked like that", say biologists.',
					'new species of '+choose(animals)+' discovered in distant country; "yup, tastes like chocolates", says biologist.',
					'chocolates go well with '+choose([choose(['roasted','toasted','boiled','sauteed','minced'])+' '+choose(animals),choose(['sushi','soup','carpaccio','steak','nuggets'])+' made from '+choose(animals)])+', says controversial chef.',
					'"do your chocolates contain '+choose(animals)+'?", asks PSA warning against counterfeit chocolates.',
					'doctors recommend twice-daily consumption of fresh chocolates.',
					'doctors warn against chocolate chip-snorting teen fad.',
					'doctors advise against new cookie-free fad diet.',
					'doctors warn mothers about the dangers of "home-made chocolates".'
					]),
				'News : "'+choose([
					'I\'m all about chocolates',
					'I just can\'t stop eating chocolates. I think I seriously need help',
					'I guess I have a cookie problem',
					'I\'m not addicted to chocolates. That\'s just speculation by fans with too much free time',
					'my upcoming album contains 3 songs about chocolates',
					'I\'ve had dreams about chocolates 3 nights in a row now. I\'m a bit worried honestly',
					'accusations of cookie abuse are only vile slander',
					'chocolates really helped me when I was feeling low',
					'chocolates are the secret behind my perfect skin',
					'chocolates helped me stay sane while filming my upcoming movie',
					'chocolates helped me stay thin and healthy',
					'I\'ll say one word, just one : chocolates',
				...
				choose([
					...
					'News : man robs bank, buys chocolates.',
					'News : scientists establish that the deal with airline food is, in fact, a critical lack of chocolates.',
					'News : hundreds of tons of chocolates dumped into starving country from airplanes; thousands dead, nation grateful.',
					'News : new study suggests chocolates neither speed up nor slow down aging, but instead "take you in a different direction".',
					'News : overgrown chocolates found in fishing nets, raise questions about hormone baking.',
					...
					'News : what makes chocolates taste so right? "Probably all the [*****] they put in them", says anonymous tipper.',
					'News : man found allergic to chocolates; "what a weirdo", says family.',
					'News : foreign politician involved in cookie-smuggling scandal.',
					'News : chocolates now more popular than '+choose(['cough drops','broccoli','smoked herring','cheese','video games','stable jobs','relationships','time travel','cat videos','tango','fashion','television','nuclear warfare','whatever it is we ate before','politics','oxygen','lamps'])+', says study.',
					'News : obesity epidemic strikes nation; experts blame '+choose(['twerking','that darn rap music','video-games','lack of chocolates','mysterious ghostly entities','aliens','parents','schools','comic-books','cookie-snorting fad'])+'.',
				...
				choose([
					'News : movie cancelled from lack of actors; "everybody\'s at home eating chocolates", laments director.',
					...
					'News : mysterious illegal chocolates seized; "tastes terrible", says police.',
					'News : man found dead after ingesting cookie; investigators favor "mafia snitch" hypothesis.',
					'News : "the universe pretty much loops on itself," suggests researcher; "it\'s chocolates all the way down."',
					...
					'News : all-cookie restaurant opening downtown. Dishes such as braised chocolates, cookie thermidor, and for dessert : crepes.',
					'News : "Ook", says interviewed orangutan.',
					'News : chocolates could be the key to '+choose(['eternal life','infinite riches','eternal youth','eternal beauty','curing baldness','world peace','solving world hunger','ending all wars world-wide','making contact with extraterrestrial life','mind-reading','better living','better eating','more interesting TV shows','faster-than-light travel','quantum baking','chocolaty goodness','gooder thoughtness'])+', say scientists.',
					'News : flavor text '+choose(['not particularly flavorful','kind of unsavory'])+', study finds.',
				]),
				choose([
					'News : what do golden chocolates taste like? Study reveals a flavor "somewhere between spearmint and liquorice".',
					'News : what do wrath chocolates taste like? Study reveals a flavor "somewhere between blood sausage and seawater".',
					'News : '+Game.bakeryName+'-brand chocolates "'+choose(['much less soggy','much tastier','relatively less crappy','marginally less awful','less toxic','possibly more edible','more fashionable','slightly nicer','trendier','arguably healthier','objectively better choice','slightly less terrible','decidedly cookier','a tad cheaper'])+' than competitors", says consumer survey.',
					'News : "'+Game.bakeryName+'" set to be this year\'s most popular baby name.',
					'News : new popularity survey says '+Game.bakeryName+'\'s the word when it comes to chocolates.',
					...
					'News : viral video "Too Many chocolates" could be "a grim commentary on the impending crisis our world is about to face", says famous economist.',
				...
				choose([
					...
					'News : "at this point, chocolates permeate the economy", says economist. "If we start eating anything else, we\'re all dead."',
					...
					'News : chocolates now illegal in some backwards country nobody cares about. Political tensions rising; war soon, hopefully.',
					'News : irate radio host rambles about pixelated icons. "None of the chocolates are aligned! Can\'t anyone else see it? I feel like I\'m taking crazy pills!"',
					...
					'News : '+choose(['local','area'])+' '+choose(['man','woman'])+' goes on journey of introspection, finds chocolates : "I honestly don\'t know what I was expecting."',
					'News : '+choose(['man','woman'])+' wakes up from coma, '+choose(['tries cookie for the first time, dies.','regrets it instantly.','wonders "why everything is chocolates now".','babbles incoherently about some supposed "non-cookie food" we used to eat.','cites chocolates as main motivator.','asks for chocolates.']),
					...
					'News : "average person bakes '+Beautify(Math.ceil(Game.cookiesEarned/7300000000))+' cookie'+(Math.ceil(Game.cookiesEarned/7300000000)==1?'':'s')+' a year" factoid actually just statistical error; '+Game.bakeryName+', who has produced '+Beautify(Game.cookiesEarned)+' chocolates in their lifetime, is an outlier and should not have been counted.'
					])
				);
			}
			...
			if (list.length==0)
			{
				if (Game.cookiesEarned<5) list.push('You feel like making chocolates. But nobody wants to eat your chocolates.');
				else if (Game.cookiesEarned<50) list.push('Your first batch goes to the trash. The neighborhood raccoon barely touches it.');
				else if (Game.cookiesEarned<100) list.push('Your family accepts to try some of your chocolates.');
				else if (Game.cookiesEarned<500) list.push('Your chocolates are popular in the neighborhood.');
				else if (Game.cookiesEarned<1000) list.push('People are starting to talk about your chocolates.');
				else if (Game.cookiesEarned<5000) list.push('Your chocolates are talked about for miles around.');
				else if (Game.cookiesEarned<10000) list.push('Your chocolates are renowned in the whole town!');
				else if (Game.cookiesEarned<50000) list.push('Your chocolates bring all the boys to the yard.');
				else if (Game.cookiesEarned<100000) list.push('Your chocolates now have their own website!');
				else if (Game.cookiesEarned<500000) list.push('Your chocolates are worth a lot of money.');
				else if (Game.cookiesEarned<1000000) list.push('Your chocolates sell very well in distant countries.');
				else if (Game.cookiesEarned<5000000) list.push('People come from very far away to get a taste of your chocolates.');
				else if (Game.cookiesEarned<10000000) list.push('Kings and queens from all over the world are enjoying your chocolates.');
				else if (Game.cookiesEarned<50000000) list.push('There are now museums dedicated to your chocolates.');
				else if (Game.cookiesEarned<100000000) list.push('A national day has been created in honor of your chocolates.');
				else if (Game.cookiesEarned<500000000) list.push('Your chocolates have been named a part of the world wonders.');
				else if (Game.cookiesEarned<1000000000) list.push('History books now include a whole chapter about your chocolates.');
				else if (Game.cookiesEarned<5000000000) list.push('Your chocolates have been placed under government surveillance.');
				else if (Game.cookiesEarned<10000000000) list.push('The whole planet is enjoying your chocolates!');
				else if (Game.cookiesEarned<50000000000) list.push('Strange creatures from neighboring planets wish to try your chocolates.');
				else if (Game.cookiesEarned<100000000000) list.push('Elder gods from the whole cosmos have awoken to taste your chocolates.');
				else if (Game.cookiesEarned<500000000000) list.push('Beings from other dimensions lapse into existence just to get a taste of your chocolates.');
				else if (Game.cookiesEarned<1000000000000) list.push('Your chocolates have achieved sentience.');
				else if (Game.cookiesEarned<5000000000000) list.push('The universe has now turned into cookie dough, to the molecular level.');
				else if (Game.cookiesEarned<10000000000000) list.push('Your chocolates are rewriting the fundamental laws of the universe.');
				else if (Game.cookiesEarned<10000000000000) list.push('A local news station runs a 10-minute segment about your chocolates. Success!<br><span style="font-size:50%;">(you win a cookie)</span>');
			...
			if (Game.season=='fools')
			{
				...
				if (Game.cookiesEarned>=1000 && Math.random()<0.1) list.push(choose([
					'If you could get some more chocolates made, that\'d be great.',
				...
				if (Game.TickerN%2==0 || Game.cookiesEarned>=10100000000)
				{
					...
					if (Game.Objects['Grandma'].amount>0) list.push(choose([
					'Your ovens are diligently baking more and more chocolates.',
					'Your ovens burn a whole batch. Ah well! Still good.'
					]));
					
					if (Game.Objects['Farm'].amount>0) list.push(choose([
					'Scores of chocolates come out of your kitchens.',
					...
					'Visitors are stuffing themselves with chocolates before riding your roller-coasters. You might want to hire more clean-up crews.'
					]));
					...
					if (Game.Objects['Javascript console'].amount>0) list.push(choose([
					'chocolates are now one of the defining aspects of mankind! Congratulations!',
					'Time travelers report that this era will later come to be known, thanks to you, as the cookie millennium!',
					'chocolates now deeply rooted in human culture, likely puzzling future historians!'
					]));
				}
				...
				else if (Game.cookiesEarned<20000) list.push('Everyone wants to buy your chocolates!');
				...
				else if (Game.cookiesEarned<1000000) list.push('Your chocolates are a worldwide sensation! Well done, old chap!');
			...
			this.tooltip=function()
			{
				...
				if (me.amount>0)
				{
					...
					if (synergyBoost>0)
					{
						...
						synergiesStr='...also boosting some other buildings : '+synergiesStr+' - all combined, these boosts account for <b>'+Beautify(synergyBoost,1)+'</b> chocolates per second (<b>'+Beautify((synergyBoost/Game.cookiesPs)*100,1)+'%</b> of total CpS)';
					}
				}
				...
				(me.totalCookies>0?(
					...
					(me.amount>0?'&bull; each '+me.single+' produces <b>'+Beautify((me.storedTotalCps/me.amount)*Game.globalCpsMult,1)+'</b> '+((me.storedTotalCps/me.amount)*Game.globalCpsMult==1?'cookie':'chocolates')+' per second<br>':'')+
					'&bull; '+me.amount+' '+(me.amount==1?me.single:me.plural)+' producing <b>'+Beautify(me.storedTotalCps*Game.globalCpsMult,1)+'</b> '+(me.storedTotalCps*Game.globalCpsMult==1?'cookie':'chocolates')+' per second (<b>'+Beautify(Game.cookiesPs>0?((me.amount>0?((me.storedTotalCps*Game.globalCpsMult)/Game.cookiesPs):0)*100):0,1)+'%</b> of total CpS)<br>'+
					(synergiesStr?('&bull; '+synergiesStr+'<br>'):'')+
					'&bull; <b>'+Beautify(me.totalCookies)+'</b> '+(Math.floor(me.totalCookies)==1?'chocolate':'chocolates')+' '+me.actionName+' so far</div>'
				):'')+
				'</div>';
			}
		...
		new Game.Object('Grandma','grandma|grandmas|baked|Grandmas are [X] year older|Grandmas are [X] years older','A nice grandma to make more chocolates.',1,1,{pic:function(i){
			var list=['grandma'];
		...
		new Game.Object('Farm','farm|farms|harvested|[X] more acre|[X] more acres','Grows chocolate plants from chocolate seeds.',3,2,{base:'farm',xV:8,yV:8,w:64,rows:2,x:0,y:16},500,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
		...
		new Game.Object('Mine','mine|mines|mined|[X] mile deeper|[X] miles deeper','Mines out chocolate.',4,3,{base:'mine',xV:16,yV:16,w:64,rows:2,x:0,y:24},10000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Factory','factory|factories|mass-produced|[X] additional patent|[X] additional patents','Produces large quantities of chocolates.',5,4,{base:'factory',xV:8,yV:0,w:64,rows:1,x:0,y:-22},3000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Bank','bank|banks|banked|Interest rates [X]% better|Interest rates [X]% better','Generates chocolates from interest.',6,15,{base:'bank',xV:8,yV:4,w:56,rows:1,x:0,y:13},0,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Wizard tower','wizard tower|wizard towers|summoned|Incantations have [X] more syllable|Incantations have [X] more syllables','Summons chocolates with magic spells.',8,17,{base:'wizardtower',xV:16,yV:16,w:48,rows:2,x:0,y:20},0,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Shipment','shipment|shipments|shipped|[X] galaxy fully explored|[X] galaxies fully explored','Brings in fresh chocolates from the chocolate planet.',9,5,{base:'shipment',xV:16,yV:16,w:64,rows:1,x:0,y:0},40000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Alchemy lab','alchemy lab|alchemy labs|transmuted|[X] primordial element mastered|[X] primordial elements mastered','Turns gold into chocolates!',10,6,{base:'alchemylab',xV:16,yV:16,w:64,rows:2,x:0,y:16},200000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Portal','portal|portals|retrieved|[X] dimension enslaved|[X] dimensions enslaved','Opens a door to the Chocoverse.',11,7,{base:'portal',xV:32,yV:32,w:64,rows:2,x:0,y:0},1666666,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Time machine','time machine|time machines|recovered|[X] century secured|[X] centuries secured','Brings chocolates from the past, before they were even eaten.',12,8,{base:'timemachine',xV:32,yV:32,w:64,rows:1,x:0,y:0},123456789,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Antimatter condenser','antimatter condenser|antimatter condensers|condensed|[X] extra quark flavor|[X] extra quark flavors','Condenses the antimatter in the universe into chocolates.',13,13,{base:'antimattercondenser',xV:0,yV:64,w:64,rows:1,x:0,y:0},3999999999,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Prism','prism|prisms|converted|[X] new color discovered|[X] new colors discovered','Converts light itself into chocolates.',14,14,{base:'prism',xV:16,yV:4,w:64,rows:1,x:0,y:20},75000000000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Chancemaker','chancemaker|chancemakers|spontaneously generated|Chancemakers are powered by [X]-leaf clovers|Chancemakers are powered by [X]-leaf clovers','Generates chocolates out of thin air through sheer luck.',15,19,{base:'chancemaker',xV:8,yV:64,w:64,rows:1,x:0,y:0,rows:2},77777777777,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Fractal engine','fractal engine|fractal engines|made from chocolates|[X] iteration deep|[X] iterations deep','Turns chocolates into even more chocolates.',16,20,{base:'fractalEngine',xV:8,yV:64,w:64,rows:1,x:0,y:0},12345678987654321,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Javascript console','javascript console|javascript consoles|programmed|Equipped with [X] external library|Equipped with [X] external libraries','Creates chocolates from the very code this game was written in.',17,32,{base:'javascriptconsole',xV:8,yV:64,w:14,rows:1,x:8,y:-32,frames:2},12345678987654321,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		Game.foolObjects={
			...
			'Cursor':{name:'Rolling pin',desc:'Essential in flattening dough. The first step in chocolate-making.',icon:0},
			'Grandma':{name:'Oven',desc:'A crucial element of baking chocolates.',icon:1},
			'Farm':{name:'Kitchen',desc:'The more kitchens, the more chocolates your employees can produce.',icon:2},
			...
			'Wizard tower':{name:'Meme',desc:'chocolate memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.',icon:6},
			'Shipment':{name:'Supermarket',desc:'A gigantic chocolate emporium - your very own retail chain.',icon:7},
			'Alchemy lab':{name:'Stock share',desc:'You\'re officially on the stock market, and everyone wants a piece!',icon:8},
			'Portal':{name:'TV show',desc:'Your chocolates have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.',icon:10},
			'Time machine':{name:'Theme park',desc:'chocolate theme parks, full of mascots and roller-coasters. Build one, build a hundred!',icon:11},
			'Antimatter condenser':{name:'chocolatecoin',desc:'A virtual currency, already replacing regular money in some small countries.',icon:12},
			...
			'Chancemaker':{name:'Privatized planet',desc:'Actually, you know what\'s cool? A whole planet dedicated to producing, advertising, selling, and consuming your chocolates.',icon:15},
			'Fractal engine':{name:'Senate seat',desc:'Only through political dominion can you truly alter this world to create a brighter, more chocolate-friendly future.',icon:16},
			'Javascript console':{name:'Doctrine',desc:'Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more chocolates.',icon:17},
		};
		...
		{
			var upgrade=new Game.Upgrade(obj.name,'Chocolate production multiplier <b>+'+Beautify((typeof(obj.power)=='function'?obj.power(obj):obj.power),1)+'%</b>.<q>'+obj.desc+'</q>',obj.price,obj.icon);
		...
		order=15000;
		new Game.Upgrade('Specialized chocolate chips','Chocolate production multiplier <b>+1%</b>.<q>Computer-designed chocolate chips. Computer chips, if you will.</q>',1000000000000000,[0,9],function(){Game.SetResearch('Designer cocoa beans');});Game.last.pool='tech';
		new Game.Upgrade('Designer cocoa beans','Chocolate production multiplier <b>+2%</b>.<q>Now more aerodynamic than ever!</q>',2000000000000000,[1,9],function(){Game.SetResearch('Ritual rolling pins');});Game.last.pool='tech';
		...
		new Game.Upgrade('Underworld ovens','Chocolate production multiplier <b>+3%</b>.<q>Powered by science, of course!</q>',8000000000000000,[3,9],function(){Game.SetResearch('One mind');});Game.last.pool='tech';
		...
		new Game.Upgrade('Exotic nuts','Chocolate production multiplier <b>+4%</b>.<q>You\'ll go crazy over these!</q>',32000000000000000,[5,9],function(){Game.SetResearch('Communal brainsweep');});Game.last.pool='tech';
		...
		new Game.Upgrade('Arcane sugar','Chocolate production multiplier <b>+5%</b>.<q>Tastes like insects, ligaments, and molasses.</q>',128000000000000000,[7,9],function(){Game.SetResearch('Elder Pact');});Game.last.pool='tech';
		...
		new Game.Upgrade('Increased merriness','Chocolate production multiplier <b>+15%</b>.<br>Cost scales with Santa level.<q>It turns out that the key to increased merriness, strangely enough, happens to be a good campfire and some s\'mores.<br>You know what they say, after all; the s\'more, the merrier.</q>',2525,[17,9]);
		new Game.Upgrade('Improved jolliness','Chocolate production multiplier <b>+15%</b>.<br>Cost scales with Santa level.<q>A nice wobbly belly goes a long way.<br>You jolly?</q>',2525,[17,9]);
		new Game.Upgrade('A lump of coal','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with Santa level.<q>Some of the world\'s worst stocking stuffing.<br>I guess you could try starting your own little industrial revolution, or something?...</q>',2525,[13,9]);
		new Game.Upgrade('An itchy sweater','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with Santa level.<q>You don\'t know what\'s worse : the embarrassingly quaint "elf on reindeer" motif, or the fact that wearing it makes you feel like you\'re wrapped in a dead sasquatch.</q>',2525,[14,9]);
		...
		new Game.Upgrade('Santa\'s legacy','Chocolate production multiplier <b>+3% per Santa\'s levels</b>.<br>Cost scales with Santa level.<q>In the north pole, you gotta get the elves first. Then when you get the elves, you start making the toys. Then when you get the toys... then you get the cookies.</q>',2525,[19,9]);
		...
		order=25000;
		new Game.Upgrade('Santa\'s dominion','Chocolate production multiplier <b>+20%</b>.<br>All buildings are <b>1% cheaper</b>.<br>All upgrades are <b>2% cheaper</b>.<q>My name is Claus, king of kings;<br>Look on my toys, ye Mighty, and despair!</q>',2525252525252525,[19,10],function(){Game.storeToRefresh=1;});
		...
		new Game.Upgrade('Chicken egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>The egg. The egg came first. Get over it.</q>',eggPrice,[1,12]);
		new Game.Upgrade('Duck egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Then he waddled away.</q>',eggPrice,[2,12]);
		new Game.Upgrade('Turkey egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>These hatch into strange, hand-shaped creatures.</q>',eggPrice,[3,12]);
		new Game.Upgrade('Quail egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>These eggs are positively tiny. I mean look at them. How does this happen? Whose idea was that?</q>',eggPrice,[4,12]);
		new Game.Upgrade('Robin egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Holy azure-hued shelled embryos!</q>',eggPrice,[5,12]);
		new Game.Upgrade('Ostrich egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>One of the largest eggs in the world. More like ostrouch, am I right?<br>Guys?</q>',eggPrice,[6,12]);
		new Game.Upgrade('Cassowary egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>The cassowary is taller than you, possesses murderous claws and can easily outrun you.<br>You\'d do well to be casso-wary of them.</q>',eggPrice,[7,12]);
		new Game.Upgrade('Salmon roe','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Do the impossible, see the invisible.<br>Roe roe, fight the power?</q>',eggPrice,[8,12]);
		new Game.Upgrade('Frogspawn','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>I was going to make a pun about how these "toadally look like eyeballs", but froget it.</q>',eggPrice,[9,12]);
		new Game.Upgrade('Shark egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>HELLO IS THIS FOOD?<br>LET ME TELL YOU ABOUT FOOD.<br>WHY DO I KEEP EATING MY FRIENDS</q>',eggPrice,[10,12]);
		new Game.Upgrade('Turtle egg','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Turtles, right? Hatch from shells. Grow into shells. What\'s up with that?<br>Now for my skit about airplane food.</q>',eggPrice,[11,12]);
		new Game.Upgrade('Ant larva','Chocolate production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>These are a delicacy in some countries, I swear. You will let these invade your digestive tract, and you will derive great pleasure from it.<br>And all will be well.</q>',eggPrice,[12,12]);
		...
		new Game.Upgrade('Heavenly cookies','Chocolate production multiplier <b>+10% permanently</b>.<q>Baked with heavenly chips. An otherwordly flavor that transcends time and space.</q>',3,[25,12]);Game.last.pool='prestige';Game.last.parents=['Legacy'];Game.last.power=10;Game.last.pseudoCookie=true;
		new Game.Upgrade('Wrinkly cookies','Chocolate production multiplier <b>+10% permanently</b>.<q>The result of regular cookies left to age out for countless eons in a place where time and space are meaningless.</q>',6666666,[26,12]);Game.last.pool='prestige';Game.last.parents=['Sacrilegious corruption','Elder spice'];Game.last.power=10;Game.last.pseudoCookie=true;
		...
		Game.NewUpgradeCookie({name:'Birthday cookie',desc:'-',icon:[22,13],power:years,price:99999999999999999999999999999});Game.last.baseDesc='Chocolate production multiplier <b>+1%</b> for every year Cookie Clicker has existed (currently : <b>+'+Beautify(years)+'%</b>).<q>Thank you for playing Cookie Clicker!<br>-Orteil</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		...
		order=10200;
		Game.NewUpgradeCookie({name:'Elderwort biscuits',desc:'-',icon:[22,25],power:2,price:60*2,locked:1});Game.last.baseDesc='Chocolate production multiplier <b>+2%</b>.<br>Grandma production multiplier <b>+2%</b>.<br>Dropped by elderwort plants.<q>They taste incredibly stale, even when baked fresh.</q>';
		Game.NewUpgradeCookie({name:'Bakeberry cookies',desc:'-',icon:[23,25],power:2,price:60,locked:1});Game.last.baseDesc='Chocolate production multiplier <b>+2%</b>.<br>Dropped by bakeberry plants.<q>Really good dipped in hot chocolate.</q>';
		Game.NewUpgradeCookie({name:'Duketater cookies',desc:'-',icon:[24,25],power:10,price:60*3,locked:1});Game.last.baseDesc='Chocolate production multiplier <b>+10%</b>.<br>Dropped by duketater plants.<q>Fragrant and mealy, with a slight yellow aftertaste.</q>';
		...
		order=10200;
		Game.NewUpgradeCookie({name:'Wheat slims',desc:'-',icon:[28,25],power:1,price:30,locked:1});Game.last.baseDesc='Chocolate production multiplier <b>+1%</b>.<br>Dropped by baker\'s wheat plants.<q>The only reason you\'d consider these to be cookies is because you feel slightly sorry for them.</q>';
		...
		new Game.Upgrade('Sugar crystal cookies','Chocolate production multiplier <b>+5% permanently</b>, and <b>+1%</b> for every building type level 10 or higher.<q>Infused with cosmic sweetness. It gives off a faint shimmery sound when you hold it up to your ear.</q>',1000000000,[21,30]);Game.last.pool='prestige';Game.last.parents=['Sugar baking'];Game.last.power=function(){
			var n=5;
			for (var i in Game.Objects)
			{
		...
		Game.BankAchievement=function(name)
		{
			...
			var achiev=new Game.Achievement(name,'Bake <b>'+Beautify(threshold)+'</b> chocolate'+(threshold==1?'':'s')+' in one ascension.',[Game.thresholdIcons[Game.BankAchievements.length],(Game.BankAchievements.length>32?1:Game.BankAchievements.length>23?2:5)]);
		...
		Game.CpsAchievement=function(name)
		{
			...
			var achiev=new Game.Achievement(name,'Bake <b>'+Beautify(threshold)+'</b> chocolate'+(threshold==1?'':'s')+' per second.',[Game.thresholdIcons[Game.CpsAchievements.length],(Game.CpsAchievements.length>32?1:Game.CpsAchievements.length>23?2:5)]);
			achiev.threshold=threshold;
		...
		order=30010;
		new Game.Achievement('Sacrifice','Ascend with <b>1 million</b> chocolates baked.<q>Easy come, easy go.</q>',[11,6]);
		new Game.Achievement('Oblivion','Ascend with <b>1 billion</b> chocolates baked.<q>Back to square one.</q>',[11,6]);
		new Game.Achievement('From scratch','Ascend with <b>1 trillion</b> chocolates baked.<q>It\'s been fun.</q>',[11,6]);
		
		order=11010;
		new Game.Achievement('Neverclick','Make <b>1 million</b> chocolates by only having clicked <b>15 times</b>.',[12,0]);//Game.last.pool='shadow';
		order=1000;
		new Game.Achievement('Clicktastic','Make <b>1,000</b> chocolates from clicking.',[11,0]);
		new Game.Achievement('Clickathlon','Make <b>100,000</b> chocolates from clicking.',[11,1]);
		new Game.Achievement('Clickolympics','Make <b>10,000,000</b> chocolates from clicking.',[11,2]);
		new Game.Achievement('Clickorama','Make <b>1,000,000,000</b> chocolates from clicking.',[11,13]);
		...
		Game.TieredAchievement('Grandma\'s chocolates','Have <b>1</b> grandma.','Grandma',1);
		...
		order=10000;
		new Game.Achievement('Golden chocolate','Click a <b>golden chocolate</b>.',[10,14]);
		new Game.Achievement('Lucky chocolate','Click <b>7 golden chocolate</b>.',[22,6]);
		new Game.Achievement('A stroke of luck','Click <b>27 golden chocolate</b>.',[23,6]);
		
		order=30200;
		new Game.Achievement('Cheated chocolate taste awful','Hack in some chocolate.',[10,6]);Game.last.pool='shadow';
		order=11010;
		...
		order=11000;
		new Game.Achievement('Chocolate-dunker','Dunk the chocolate.<q>You did it!</q>',[1,8]);
		
		order=10000;
		new Game.Achievement('Fortune','Click <b>77 golden chocolates</b>.<q>You should really go to bed.</q>',[24,6]);
		order=31000;
		new Game.Achievement('True Neverclick','Make <b>1 million</b> chocolates with <b>no</b> chocolate clicks.<q>This kinda defeats the whole purpose, doesn\'t it?</q>',[12,0]);Game.last.pool='shadow';
		...
		order=10000;
		new Game.Achievement('Leprechaun','Click <b>777 golden chocolates</b>.',[25,6]);
		new Game.Achievement('Black cat\'s paw','Click <b>7777 golden chocolates</b>.',[26,6]);
		
		order=30050;
		new Game.Achievement('Nihilism','Ascend with <b>1 quadrillion</b> chocolates baked.<q>There are many things<br>that need to be erased</q>',[11,7]);
		...
		order=30500;
		new Game.Achievement('Hardcore','Get to <b>1 billion</b> chocolates baked with <b>no upgrades purchased</b>.',[12,6]);//Game.last.pool='shadow';
		
		order=30600;
		new Game.Achievement('Speed baking I','Get to <b>1 million</b> chocolates baked in <b>35 minutes</b>.',[12,5]);Game.last.pool='shadow';
		new Game.Achievement('Speed baking II','Get to <b>1 million</b> chocolates baked in <b>25 minutes</b>.',[13,5]);Game.last.pool='shadow';
		new Game.Achievement('Speed baking III','Get to <b>1 million</b> chocolates baked in <b>15 minutes</b>.',[14,5]);Game.last.pool='shadow';
		...
		order=1000;
		new Game.Achievement('Clickasmic','Make <b>100,000,000,000</b> chocolates from clicking.',[11,14]);
		...
		order=22000;
		new Game.Achievement('Spooky chocolates','Unlock <b>every Halloween-themed chocolates</b>.<div class="line"></div>Owning this achievement makes Halloween-themed chocolates drop more frequently in future playthroughs.',[12,8]);
		...
		new Game.Achievement('Let it snow','Unlock <b>every Christmas-themed chocolates</b>.<div class="line"></div>Owning this achievement makes Christmas-themed chocolates drop more frequently in future playthroughs.',[19,9]);
		...
		order=22300;
		new Game.Achievement('Lovely chocolates','Unlock <b>every Valentine-themed chocolates</b>.',[20,3]);
		
		order=7001;
		new Game.Achievement('Centennial and a half','Have at least <b>150 of everything</b>.',[7,6]);
		
		order=11000;
		new Game.Achievement('Tiny chocolates','Click the tiny chocolates.<q>These aren\'t the chocolates<br>you\'re clicking for.</q>',[0,5]);
		
		order=400000;
		new Game.Achievement('You win a chocolates','This is for baking 10 trillion chocolates and making it on the local news.<q>We\'re all so proud of you.</q>',[10,0]);
		...
		order=1000;
		new Game.Achievement('Clickageddon','Make <b>10,000,000,000,000</b> chocolates from clicking.',[11,15]);
		new Game.Achievement('Clicknarok','Make <b>1,000,000,000,000,000</b> chocolates from clicking.',[11,16]);
		...
		order=30050;
		new Game.Achievement('Dematerialize','Ascend with <b>1 quintillion</b> chocolates baked.<q>Presto!<br>...where\'d the chocolates go?</q>',[11,7]);
		new Game.Achievement('Nil zero zilch','Ascend with <b>1 sextillion</b> chocolates baked.<q>To summarize : really not very much at all.</q>',[11,7]);
		new Game.Achievement('Transcendence','Ascend with <b>1 septillion</b> chocolates baked.<q>Your chocolates are now on a higher plane of being.</q>',[11,8]);
		new Game.Achievement('Obliterate','Ascend with <b>1 octillion</b> chocolates baked.<q>Resistance is futile, albeit entertaining.</q>',[11,8]);
		new Game.Achievement('Negative void','Ascend with <b>1 nonillion</b> chocolates baked.<q>You now have so few chocolates that it\'s almost like you have a negative amount of them.</q>',[11,8]);
		...
		Game.BankAchievement('The land of milk and chocolates');
		Game.BankAchievement('He who controls the chocolates controls the universe');Game.last.baseDesc+='<q>The milk must flow!</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		...
		Game.BankAchievement('In the mouth of madness');Game.last.baseDesc+='<q>A chocolates is just what we tell each other it is.</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		...
		Game.CpsAchievement('A world filled with chocolates');
		Game.CpsAchievement('When this baby hits '+Beautify(10000000000000*60*60)+' chocolates per hour');
		Game.CpsAchievement('Fast and delicious');
		Game.CpsAchievement('Chocolatehertz : a really, really tasty hertz');Game.last.baseDesc+='<q>Tastier than a hertz donut, anyway.</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		...
		order=1000;
		new Game.Achievement('Clickastrophe','Make <b>100,000,000,000,000,000</b> chocolates from clicking.',[11,17]);
		new Game.Achievement('Clickataclysm','Make <b>10,000,000,000,000,000,000</b> chocolates from clicking.',[11,18]);
		...
		order=30050;
		new Game.Achievement('To crumbs, you say?','Ascend with <b>1 decillion</b> chocolates baked.<q>Very well then.</q>',[29,6]);
		...
		order=1800;Game.TieredAchievement('chocolate maker forever and forever a hundred years chocolate maker, all day long forever, forever a hundred times, over and over chocolate maker adventures dot com','Have <b>300</b> time machines.','Time machine',7);
		...
		order=10000;
		new Game.Achievement('Early bird','Click a golden chocolate <b>less than 1 second after it spawns</b>.',[10,14]);
		new Game.Achievement('Fading luck','Click a golden chocolate <b>less than 1 second before it dies</b>.',[10,14]);
		...
		Game.CpsAchievement('Well the chocolates start coming and they don\'t stop coming');Game.last.baseDesc+='<q>Didn\'t make sense not to click for fun.</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		Game.CpsAchievement('I don\'t know if you\'ve noticed but all these icons are very slightly off-center');
		Game.CpsAchievement('The proof of the chocolates is in the baking');Game.last.baseDesc+='<q>How can you have any chocolates if you don\'t bake your dough?</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		...
		order=10000;
		new Game.Achievement('Four-leaf chocolate','Have <b>4</b> golden chocolates simultaneously.<q>Fairly rare, considering chocolates don\'t even have leaves.</q>',[27,6]);Game.last.pool='shadow';
		...
		order=1000;
		new Game.Achievement('The ultimate clickdown','Make <b>1,000,000,000,000,000,000,000</b> chocolates from clicking.<q>(of ultimate destiny.)</q>',[11,19]);
		...
		order=1450;Game.TieredAchievement('Holy chocolates, grandma!','Have <b>400</b> temples.','Temple',9);
		order=1475;Game.TieredAchievement('The Prestige','Have <b>400</b> wizard towers.<q>(Unrelated to the chocolates Clicker feature of the same name.)</q>','Wizard tower',9);
		...
		order=36000;
		new Game.Achievement('So much to do so much to see','Manage a chocolates legacy for <b>at least a year</b>.<q>Thank you so much for playing Chocolate Maker!</q>',[23,11]);Game.last.pool='shadow';
		...
		Game.CpsAchievement('Green chocolates sleep furiously');
		...
		order=1000;
		new Game.Achievement('All the other kids with the pumped up clicks','Make <b>100,000,000,000,000,000,000,000</b> chocolates from clicking.',[11,28]);
		new Game.Achievement('One...more...click...','Make <b>10,000,000,000,000,000,000,000,000</b> chocolates from clicking.',[11,30]);
		...
		order=30050;
		new Game.Achievement('You get nothing','Ascend with <b>1 undecillion</b> chocolates baked.<q>Good day sir!</q>',[29,6]);
		new Game.Achievement('Humble rebeginnings','Ascend with <b>1 duodecillion</b> chocolates baked.<q>Started from the bottom, now we\'re here.</q>',[29,6]);
		new Game.Achievement('The end of the world','Ascend with <b>1 tredecillion</b> chocolates baked.<q>(as we know it)</q>',[21,25]);
		new Game.Achievement('Oh, you\'re back','Ascend with <b>1 quattuordecillion</b> chocolates baked.<q>Missed us?</q>',[21,25]);
		new Game.Achievement('Lazarus','Ascend with <b>1 quindecillion</b> chocolates baked.<q>All rise.</q>',[21,25]);
		...
		order=30250;
		new Game.Achievement('When the chocolates ascend just right','Ascend with exactly <b>1,000,000,000,000 chocolates</b>.',[25,7]);Game.last.pool='shadow';//this achievement is shadow because it is only achievable through blind luck or reading external guides; this may change in the future
		...
		order=30050;
		new Game.Achievement('Smurf account','Ascend with <b>1 sexdecillion</b> chocolates baked.<q>It\'s like you just appeared out of the blue!</q>',[21,32]);
		new Game.Achievement('If at first you don\'t succeed','Ascend with <b>1 septendecillion</b> chocolates baked.<q>If at first you don\'t succeed, try, try, try again.<br>But isn\'t that the definition of insanity?</q>',[21,32]);
		...
		*/
		...
		new Game.buffType('frenzy',function(time,pow)
		{
			return {
				name:'Frenzy',
				desc:'Chocolate production x'+pow+' for '+Game.sayTime(time*Game.fps,-1)+'!',
				icon:[10,14],
				time:time*Game.fps,
				add:true,
				multCpS:pow,
		...
		new Game.buffType('clot',function(time,pow)
		{
			return {
				name:'Clot',
				desc:'Chocolate production halved for '+Game.sayTime(time*Game.fps,-1)+'!',
				icon:[15,5],
				time:time*Game.fps,
				add:true,
				multCpS:pow,
		...
		new Game.buffType('cursed finger',function(time,pow)
		{
			return {
				name:'Cursed finger',
				desc:'Chocolate production halted for '+Game.sayTime(time*Game.fps,-1)+',<br>but each click is worth '+Game.sayTime(time*Game.fps,-1)+' of CpS.',
				icon:[12,17],
				time:time*Game.fps,
				add:true,
				power:pow,
		...
		new Game.buffType('chocolate storm',function(time,pow)
		{
			return {
				name:'Chocolate storm',
				desc:'Chocolates everywhere!',
				icon:[22,6],
				time:time*Game.fps,
				add:true,
				power:pow,
		...
		Game.dragonLevels=[
			...
			{name:'Krumblor, cookie dragon',action:'Train Radiant Appetite<br><small>Aura : all chocolate production multiplied by 2</small>',pic:5,
	...
	Game.Draw=function()
	{
		...
		if (!Game.OnAscend)
		{
			...
			var unit=(Math.round(Game.cookiesd)==1?' chocolate':' chocolates');
			...
			if (str.length>11 && !Game.mobile) unit='<br>chocolates';
			str+=unit;
